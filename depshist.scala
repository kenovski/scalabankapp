...
class BankDeposits(val date: Date,val name:String,val acctno:String,val amount:Double){
...
// or provide custom MongoClientSettings
         ...
         val collection: MongoCollection[Document] = database.getCollection("deposits");
